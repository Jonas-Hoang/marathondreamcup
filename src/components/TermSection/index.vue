        ...
        <div class="section-content relative">
          <div class="row align-middle">
            <div class="col medium-5 small-12 large-7" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500" data-aos-offset="200">
              ...
              <a class="button bg-[#ffbe4e] my-[20px] text-black px-[1.2em] max-w-[100%] hover:bg-[#f5ca66]" rel="noopener noreferrer" href="https://drive.google.com/file/d/1314JujSnObg_8tVDFhstFbHWASh7F2Ez/view" target="_blank" style="border-radius: 99px"><span>Đọc kỹ điều khoản &amp; điều kiện</span><i class="icon-angle-right" aria-hidden="true"></i></a>
              <div class="ux-timer">
              ...
              <span class="mt-[10px] text-[400] text-[22px] pb-[10px] text-[#214184]">vận động viên (dự kiến)</span>
            </div>
