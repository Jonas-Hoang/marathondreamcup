        ...
        <div class="section-content relative">
          <div class="row align-middle">
            <div class="col medium-5 small-12 large-7" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500" data-aos-offset="200">
              ...
              <p class="text-[19px] font-[300] !text-2xl">Running Diamond Cup 2024</p>
              ...
              <span class="text-[400] mt-[15px] text-[22px] mb-[10px]">Đếm ngược tới ngày sự kiện diễn ra với</span>
              <div class="flex items-center justify-center lg:w-[80%] md:w-[90%] sm:[100%] px-[30px] mt-[5px]">
                <span class="text-[60px] font-bold">5.000+</span>
              </div>
              <span class="mt-[10px] text-[400] text-[22px] pb-[10px]">vận động viên (dự kiến)</span>
            </div>
